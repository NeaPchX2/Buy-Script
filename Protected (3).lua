local HWID = {
    ...
    "d0f7c0ca-1e63-4c12-b975-136e305c152c",
    ""
 }
...
local webhook = syn.request({
    ...
    Url = 'https://discord.com/api/webhooks/997565906844659734/Gdbeyqi6K0dk6J4b-IbsFf7H3yOEYIYueelwvWyVAa7rOBG2FBYgmC_c0sfV_WzzxwKO',
...
print(webhook.StatusCode)


    game.StarterGui:SetCore("SendNotification", {
    Icon = "rbxassetid://10253485337";
    Title = "Sxnumz HUB", 
    Text = "Welcome to Sxnumz HUB"
})
...
local LogoHub = Instance.new("ImageLabel")
	...
	LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(10253485337)
...
local LogoToggle = Instance.new("ImageLabel")
	...
	LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(10253485337)
    ...
    spawn(function()
        ...
        pcall(function()
            ...
            game:GetService("RunService").Stepped:Connect(function()
                ...
                if _G.AutoAdvanceDungeon or _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.AutoFarmChest or _G.AutoFarmBossHallow or _G.AutoFarmSwanGlasses or _G.AutoLongSword or _G.AutoBlackSpikeycoat or _G.AutoElectricClaw or _G.AutoFarmGunMastery or _G.AutoHolyTorch or _G.AutoLawRaid or _G.AutoFarmBoss or _G.AutoTwinHooks or _G.AutoOpenSwanDoor or _G.AutoDragon_Trident or _G.AutoSaber or _G.NOCLIP or _G.AutoFarmFruitMastery or _G.AutoFarmGunMastery or _G.TeleportIsland or _G.Auto_EvoRace or _G.AutoFarmAllMsBypassType or _G.AutoObservationv2 or _G.AutoMusketeerHat or _G.AutoEctoplasm or _G.AutoRengoku or _G.Auto_Rainbow_Haki or _G.AutoObservation or _G.AutoDarkDagger or _G.Safe_Mode or _G.MasteryFruit or _G.AutoBudySword or _G.AutoOderSword or _G.AutoBounty or _G.AutoAllBoss or _G.Auto_Bounty or _G.AutoSharkman or _G.Auto_Mastery_Fruit or _G.Auto_Mastery_Gun or _G.Auto_Dungeon or _G.Auto_Cavender or _G.Auto_Pole or _G.Auto_Kill_Ply or _G.Auto_Factory or _G.AutoSecondSea or _G.TeleportPly or _G.AutoBartilo or _G.Auto_DarkBoss or _G.GrabChest or _G.AutoFarmBounty or _G.Holy_Torch or _G.AutoFarm or _G.Clip or _G.AutoElitehunter or _G.AutoThirdSea or _G.Auto_Bone or _G.AutoFarmCandy or _G.AutoTushita == true then
                    ...
                    elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                        ...
                        if game:GetService("Workspace").Enemies:FindFirstChild(Mon) then
                                    ...
                                    if v.Name == Mon then
                                        ...
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                            ...
                                            repeat task.wait()
                                               ...
                                               TP1(v.HumanoidRootPart.CFrame * CFrame.new(0,0,30))
                            ...
                            if game:GetService("ReplicatedStorage"):FindFirstChild(Mon) then
                                ...
                                TP1(game:GetService("ReplicatedStorage"):FindFirstChild(Mon).HumanoidRootPart.CFrame * CFrame.new(2,60,2))
...
local Library = Update:Window("SXNUMZ","",Enum.KeyCode.RightControl);
Main = Library:Tab("Main",6026568198)
Stats = Library:Tab("Auto Stats",7040410130)
Settings = Library:Tab("Misc Game",6034509993)

Main:Seperator("FarmMod")
...
Main:Toggle("AutoFarm Level",_G.AutoFarm,function(value)
    ...
    Main:Seperator("     ModeFarm")

    Main:Toggle("Back Farm",true,function(value)

    _G.J = value

    end)

    Main:Toggle("Underground Farm ",nil,function(value)
    ...
    Stats:Toggle("Kaitan Stats",_G.Auto_Gun,function(value)
    _G.Auto_Melee = value
    _G.Auto_Defense = value
    end)
    _G.PointStats = 1
    Stats:Slider("",1,100,1,function(value)
        _G.PointStats = value
    end)
    ...
    Settings:Button("FPS Boost",function()
        pcall(function()
    ...
    Settings:Button("Redeem All Codes",function()
    ...
    Settings:Dropdown("Selected Codes Reset stat",{"RESET_5B","SUB2GAMERROBOT_RESET1","Sub2UncleKizaru"},function(value)
        _G.CodeSelect = value
    end)
    
    Settings:Button("Redeem Code (Selected Codes)",function()
...
spawn(function()
 ...
 Settings:Toggle("SuperVeryFast Attack", true,function(value)
...
while cac() do 
	AttackNoCD()
     ...
     game.Players.LocalPlayer:Kick("NO HWID !")
     wait(.5)
     game:Shutdown()
 end